...
public class Fruit {
	...
	public Fruit(String name, String department, String town, int idTown, String gender, String ageGroup,
			String sisbenScore, int beneficiaries, double investment, double hectare) {
		this.name = name;
	...
	public void setSisbenScore(String sisbenScore) {
		this.sisbenScore = sisbenScore;
	}

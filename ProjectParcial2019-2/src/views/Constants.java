...
public class Constants {
	...
	public static final int M_WIDTH_SIZE = 1000;
	public static final int M_HEIGHT_SIZE = 600;
	
	//Constants for Fonts
	public static final Font DEFAULT_FONT = new Font("Segoe UI", Font.BOLD, 14);
	public static final Font DEFAULT_FONT_MAX = new Font("Segoe UI", Font.BOLD, 17);
	public static final Font DEFAULT_FONT_MIN = new Font("Segoe UI", Font.BOLD, 12);
	...
	public static final String NARIÑO = "NARIÑO";
	...
	public static final String ID_NARIÑO = "52";
